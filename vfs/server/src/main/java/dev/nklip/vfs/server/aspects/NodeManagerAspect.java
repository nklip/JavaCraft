package dev.nklip.vfs.server.aspects;
...
//    @AfterReturning(pointcut="@annotation(dev.nklip.vfs.server.aspects.CreateNode)", returning="node")
//    public void newNode(Node node) {
//        lockService.addNode(node);
//    }
//
//    @After("@annotation(dev.nklip.vfs.server.aspects.RemoveNode)")
