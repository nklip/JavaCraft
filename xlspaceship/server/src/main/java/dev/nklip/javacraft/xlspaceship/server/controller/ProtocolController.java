...
@RequestMapping(value = ApiPaths.PROTOCOL_PATH)
...
public class ProtocolController {
    ...
    public NewGameResponse createNewGame(@RequestBody NewGameRequest newGameRequest) {
        ...
        return gameSessionService.createRemoteGame(newGameRequest);
    }
    ...
    public ResponseEntity<?> fireFromEnemy(
            ...
            @RequestBody SalvoRequest salvoRequestByOpponent) {
        ResponseEntity<?> validResponse = gameRequestValidationService.validateFireRequest(salvoRequestByOpponent);
        if (validResponse != null) {
            return validResponse;
        }

        return gameRequestValidationService.fireFromEnemy(gameId, salvoRequestByOpponent);
    }
